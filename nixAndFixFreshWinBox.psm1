...
function ChangeDesktopBackground {
    Start-BitsTransfer -Source "https://github.com/secdevlowe/nixAndFixFreshWindowsBox/blob/main/img/Wallpaper.zip" -Destination $ENV:WINDIR\Web\Wallpaper\Windows\Wallpaper.jpg
